...
/** Modal/confirm con animazione pop-in + backdrop sfocato. */
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        className={cn(
          "animate-pop relative w-full overflow-y-auto rounded-2xl border border-border-strong bg-card p-5 shadow-[--shadow-pop] max-h-[90vh]",
          width
        )}
      >
        <div className="mb-4 flex items-center justify-between gap-3">
          ...
          <button
            onClick={onClose}
            className="rounded-lg p-1 text-muted-foreground transition-colors hover:bg-elevated hover:text-foreground"
            aria-label="Chiudi"
          >
